...
! function () {
	...
	}), g = '<div class="bd-clipboard"><button type="button" class="btn-clipboard" title="کپی در کلیپ بورد">Copy</button></div>', document.querySelectorAll('div.highlight').forEach(function (a) {
