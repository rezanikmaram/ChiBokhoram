...
var chartUserCount = new ApexCharts(document.querySelector("#earning-chart"), UserCountOptions);
...
var UserCountOptions ={
  ...
  var chartUserCount = new ApexCharts(document.querySelector("#weekly-chart"), UserCountOptions);
  chartUserCount.render();
// weekly chart end
...
var chartUserCount = new ApexCharts(document.querySelector("#transaction-chart"), UserCountOptions);
chartUserCount.render();
...
var UserCountOptions = {
  ...
  var chartUserCount = new ApexCharts(document.querySelector("#yearly-chart"), UserCountOptions);
