...
{
    public abstract class BaseDto3<TDto, TEntity, TKey> : IHaveCustomMapping
        ...
        where TEntity :BaseEntity<TKey>, new()
    {
        ...
        protected TDto CastToDerivedClass(IMapper mapper, BaseDto3<TDto, TEntity, TKey> baseInstance)
        {
        ...
        public void CreateMappings(Profile profile)
        {
           ...
           // CustomMappingDtoToEntity(mappingExpression.ReverseMap());
    ...
    public abstract class BaseDto3<TDto, TEntity> : BaseDto3<TDto, TEntity, int>
        where TDto : class, new()
