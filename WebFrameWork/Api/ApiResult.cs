...
namespace WebFramework.Api
{
    ...
    public class ApiResultV<TValue> : ApiResult where TValue : struct
    {
        public TValue? Data { get; set; }

        public ApiResultV(bool isSuccess, ApiResultStatusCode statusCode, TValue? data, string message = null) : base(isSuccess, statusCode, message)
        {
        }
